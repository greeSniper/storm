...
public class GenerateData {
    ...
    public static String generateOne1(long personId) {
        return personId + "," + generateName() + ",[" + generateWorkStartTime() + "," + generateWorkEndTime() + ", " + ", " + "]";
    }

    public static String generateOne2(long personId) {
        return personId + "," + generateName() + ",[" + generateWorkStartTime() + "," + generateNoonStartTime() + "," + generateNoonEndTime() + "," + generateWorkEndTime() + "]";
    }
    ...
    public static void generateBatch() throws IOException {
        ...
        int i = 1;
        for(; i<=10; i++) {
            output.write(generateOne1(i));
            output.write("\r\n");
        }
        for(; i<=20; i++) {
            output.write(generateOne2(i));
            output.write("\r\n");
        }
